...
const ViewProperty = () => {
    ...
    return (
        <div>
         ...
         <div>
      <h1 className="text-5xl my-2 font-bold">{property.estate_title}</h1>
      <h1 className="text-2xl my-2 font-bold mt-2 py-3">{property.segment_name}</h1>
      ...
      <div className="text-2xl my-2  text-green-400  font-bold rounded-xl flex">
        ...
        <p className="text-xl my-2">
            <span className="mr-3 text-amber-200">{property.facilities[0]}</span>
            <span className="mr-3 text-slate-300">{property.facilities[1]}</span>
            <span className="ml-3  text-slate-300">{property.facilities[2]}</span>
            <span className="ml-3  text-slate-300">{property.facilities[3]}</span>
            <span className="ml-3  text-slate-300">{property.facilities[4]}</span>
        </p>
